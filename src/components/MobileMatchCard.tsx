    ...
    <div className="border-b border-border bg-card">
      ...
      <div className="flex items-center justify-between px-3 py-2">
        ...
        <div className="flex items-center gap-2 ml-2">
          ...
          <button className="w-6 h-6 bg-accent rounded flex items-center justify-center">
            <MoreVertical className="w-3 h-3 text-accent-foreground" />
          </button>
        </div>
      </div>
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-0.5">
            <OddsButton 
              ...
              onClick={() => handleOddClick("1X2", "1", odds["1x2"]["1"])}
            />
            <OddsButton 
              value={odds["1x2"].x}
              isSelected={isSelected(`${matchId}-1X2-X`)}
              onClick={() => handleOddClick("1X2", "X", odds["1x2"].x)}
            />
            <OddsButton 
              value={odds["1x2"]["2"]}
              isSelected={isSelected(`${matchId}-1X2-2`)}
              onClick={() => handleOddClick("1X2", "2", odds["1x2"]["2"])}
            />
          </div>
        </div>
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-0.5">
            ...
            <OddsButton 
              ...
              onClick={() => handleOddClick("Handicap", "Home", odds.handicap.home)}
            />
            <OddsButton 
              value={odds.handicap.away}
              isSelected={isSelected(`${matchId}-Handicap-Away`)}
              onClick={() => handleOddClick("Handicap", "Away", odds.handicap.away)}
            />
          </div>
        </div>
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-0.5">
            ...
            <OddsButton 
              ...
              onClick={() => handleOddClick("Total", "Over", odds.total.over)}
            />
            <OddsButton 
              value={odds.total.under}
              isSelected={isSelected(`${matchId}-Total-Under`)}
              onClick={() => handleOddClick("Total", "Under", odds.total.under)}
            />
          </div>
        </div>
      </div>
